...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first movement of the first quartet, Op. 2, No. 1, B.307 has the following files:
